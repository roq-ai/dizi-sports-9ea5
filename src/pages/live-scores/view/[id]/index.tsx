...
import { getLiveScoreById } from 'apiSdk/live-scores';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Live Score Detail View
          </Text>
          {hasAccess('live_score', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/live-scores/edit/${data?.id}`} passHref legacyBehavior>
              <Button
